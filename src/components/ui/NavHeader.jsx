...
export default function NavHeader() {
  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-50 flex justify-center pointer-events-none">
      <ul
        className="pointer-events-auto relative flex w-[360px] justify-center items-center rounded-full border border-white/20 bg-black/50 backdrop-blur-md py-12 shadow-xl gap-6"
